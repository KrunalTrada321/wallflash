...
//         // Check if the product was already purchased
...
//             // Finish transaction to avoid duplicate purchases
//             try {
...
//         <Text
//           style={{
//             fontSize: 60,           // Large and prominent
//             marginBottom: 20,       // Space between emoji and gradient card
//             textAlign: "center",    // Centered horizontally
//             color: "#FFD700",       // Golden color to match premium theme
//             textShadowColor: "rgba(0,0,0,0.5)", // Optional: subtle shadow
